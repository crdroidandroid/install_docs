...
```
fastboot flash dtbo dtbo_v12.X.img
fastboot flash vbmeta vbmeta_v12.X.img
```

## Installing crDroid Recovery using ***fastboot***

1. Download **crDroid Recovery** (see download page, recovery button). Simply download the latest recovery file, named ***recovery_v12.X.img***.
...
```
fastboot flash recovery recovery_v12.X.img
```
