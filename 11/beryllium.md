...
* Optional KernelSU Next (get it on [release page](https://github.com/rifsxd/KernelSU-Next/releases) from GitHub - click on Show all assets text link and scroll down to the apk)
