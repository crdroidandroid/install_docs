...
### Installing recovery
Get the latest boot.img from the Recovery section on the download page. Run "fastboot flash boot /path/to/boot.img". Now press volume up until you see "Recovery Mode", then press power.
