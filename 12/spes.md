...
```
adb sideload crDroidAndroid-16.0-20251011-spes-v12.1.zip
```
...
* Flash GApps .zip **after flashing ROM** when asked to reboot to recovery click yes, after that you can click Apply update and proceed with: 
