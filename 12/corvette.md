...
https://github.com/crdroidandroid/android_device_oneplus_corvette/blob/16.0/proprietary-files.txt#L2
...
* Download support files from the site:
  ...
  - **vendor_boot.img**
  - **recovery.img**
* Download the latest GApps (referred to as **nikgapps.zip**).
