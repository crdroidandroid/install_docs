...
* CrDroid Recovery: [Download](https://drive.google.com/file/d/1jUweqlrtVYkERCdMNC52UIOCW6hV4thN/view?usp=drive_link)
### Installing CrDroid Recovery 
...
* Hold volume down + power until screen goes black, then hold volume up + power until you see TWRP screen, all while phone is connected to computer.
* Now you are booted to CrDroid Recovery
### Fisrt time installation
* ### Installing via CrDroid Recovery
* ***Note: Please go through the Installing Crdroid Recovery once***
...
* Reboot and enjoy !!!
### 2. Using ADB Sideload on crDroid Recovery 
