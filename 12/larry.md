...
* Download copy-partitions-signed.zip if you are on CPH246x.15.0.0.1600 or newer firmware.
...
* If you are on CPH246x.15.0.0.1600 or newer firmware, sideload copy-partitions-signed.zip (adb sideload copy-partitions-signed.zip).
