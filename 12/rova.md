...
* KernelSU-NEXT (KSU-NEXT) - ([Download from here](https://github.com/KernelSU-Next/KernelSU-Next/releases/download/v1.1.1/KernelSU_Next_v1.1.1_12851-release.apk))
* Firmware
