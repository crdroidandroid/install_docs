...
[Links crDroid Device Group and Support Community](https://crdroid.net/hotdog/11/support)
...
1. Download the latest versions of the following files from [here](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/recovery/).
...
1. Download [crDroid Recovery](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/recovery/). Simply download the latest recovery file, named `crDroidAndroid-15.0-YYYYMMDD-v11.X-recovery.img`.
...
1. Download the latest [crDroid zip file](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/).
...
> **Warning!**  
> If you want to install Google Apps add-on package (use the `arm64` architecture), you can download it from [here](https://sourceforge.net/projects/nikgapps/files/Elite-Releases/crdroid-official/Android-15/). This add-on needs to be installed `before` booting into crDroid for the first time!
...
## Via recovery:
1. Download the latest [crDroid zip file](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/).
    - If the Google Apps add-on has been installed, then check the new version [here](https://sourceforge.net/projects/nikgapps/files/Elite-Releases/crdroid-official/Android-15/).
2. If you are not in recovery, reboot into recovery:
    - With the device powered off, hold `Volume Down` + `Power`.
...
1. Download the latest version of `recovery` image from [here](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/recovery/).
2. Download the latest [crDroid install package](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/).
3. If you are currently using (or now want to use) an application package add-on such as Google Apps, you have the following options:
    - keep using them: [Download](https://sourceforge.net/projects/nikgapps/files/Elite-Releases/crdroid-official/Android-15/) the appropriate version now.
    - remove them: You can only do so by performing a factory reset, which will also remove all your data.
    - start using them: You can only do so by performing a factory reset, which will also remove all your data. [crDroid install package](https://sourceforge.net/projects/crdroid/files/hotdog/11.x/) the appropriate version now.
4. Make sure your computer has working adb.
5. Enable USB debugging on your device.
6. __Important!__ Remove encryption on the device (fingerprints/face/passwords/graphic keys/PIN/etc..) and set `Screen lock` to `None`.
